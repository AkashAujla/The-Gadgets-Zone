					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="category.php?category=Headphones"class="cta-btn">Shoow <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="category.php?category=Cameras"class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
		...
		<!-- SECTION -->
								...
								<div class='product'>
									<a href='product.php?p=$pro_id'><div class='product-img'>
										<img src='14 Pro Max.jpg' style='max-height: 170px;' alt=''>
